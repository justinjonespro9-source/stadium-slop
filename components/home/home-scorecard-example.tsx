    ...
    >
      <div className="home-scorecard-example__layout">
        <div className="home-scorecard-example__copy min-w-0">
          ...
          <p className="home-scorecard-example__lede mt-2 text-sm leading-relaxed text-[var(--media-ink-muted)] sm:text-[0.9375rem]">
          ...
          <div className="home-scorecard-example__badges mt-4 flex flex-wrap items-center gap-2">
          ...
          <p className="home-scorecard-example__trust-line mt-4 text-xs font-bold leading-snug text-[var(--media-orange-deep)] sm:text-[0.8125rem]">
            {HOME_SCORECARD_TRUST_TAGLINE}
          </p>
          <p className="home-scorecard-example__explainer mt-3 text-xs leading-relaxed text-[var(--media-ink-muted)] sm:text-sm">
            Flip once to see Slop Signals on the back: napkin rating, replay value, price check,
            and a hot take.
          </p>
        </div>

        <div className="home-scorecard-example__preview min-w-0">
          <div className="home-scorecard-example__preview-panel">
            <HomeScorecardFlipExample />
          </div>
        </div>

        <ul
          className="home-scorecard-example__features"
